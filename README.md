About cockroachdb-python-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cockroachdb-python-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9069&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cockroachdb-python-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cockroachdb-python` can be installed with `conda`:
...
```
mamba install cockroachdb-python
```

It is possible to list all of the versions of `cockroachdb-python` available on your platform with `conda`:
...
```
mamba search cockroachdb-python --channel conda-forge
```
...
mamba repoquery search cockroachdb-python --channel conda-forge

# List packages depending on `cockroachdb-python`:
mamba repoquery whoneeds cockroachdb-python --channel conda-forge

# List dependencies of `cockroachdb-python`:
mamba repoquery depends cockroachdb-python --channel conda-forge
```
